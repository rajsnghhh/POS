...
const routes: Routes = [
  {
    path: 'download',
    loadChildren: () =>
      import('./download-app/download-app.module')
        .then(m => m.DownloadAppModule)
  },
  {
    path: 'version',
    loadChildren: () =>
      import('./version-control/version-control.module')
        .then(m => m.VersionControlModule)
  },
  {
    path: 'not-found',
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          path: 'pos-product',
          loadChildren: () =>
            import('./pos-product/pos-product.module').then(
              m => m.PosProductModule)
        },
        {
          path: '',
          canLoad: [AuthGuard],
        ...
        },
        {
          ...
          path: 'batch',
          loadChildren: () =>
            import('./batch/batch.module').then(
              m => m.BatchModule
            )
        }, {
          path: 'warehouse',
        ...
        {
          path: 'daily-grn-report',
          loadChildren: () =>
            import('./reports/daily-grn-report/daily-grn-report.module').then(
              m => m.DailyGrnReportModule
            )
        },
        {
          path: 'stock-return',
          loadChildren: () =>
            import('./reports/stock-return/stock-return.module').then(
              m => m.StockReturnModule
            )
        },
        {
          path: 'pending-price-report',
          loadChildren: () =>
            import('./reports/pending-price-report/pending-price-report.module').then(
              m => m.PendingPriceReportModule
            )
        },
        {
        ...
        },
        {
          ...
          loadChildren: () =>
            import('./image-upload/image-upload.module')
              .then(m => m.ImageUploadModule)
        },
        {
          path: 'rewards-point',
          canLoad: [AuthGuard],
          loadChildren: () =>
            import('./rewards-point/rewards-point.module')
              .then(m => m.RewardsPointModule)
        },
        {
          path: '**',
