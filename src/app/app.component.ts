...
export class AppComponent extends BaseComponent implements OnInit {
    ...
    this.router.events
      ...
      .subscribe((event: NavigationEnd) => {
        if (
          ...
          event.url.indexOf('daily-grn-report') > -1 ||
          event.url.indexOf('pending-price-report') > -1 ||
          ...
          event.url.indexOf('stock-return') > -1 ||
          ...
          event.url.indexOf('batch') > -1 ||
          event.url.indexOf('batch-assign') > -1 ||
          event.url.indexOf('waste-product') > -1
          ...
          event.url.indexOf('notifications') > -1
        ) {
          this.commonService.setCurrentUrl('notifications');
        }
        else if (
          event.url.indexOf('inventory') > -1
        ) {
          this.commonService.setCurrentUrl('inventory');
        }
        else {
  ...
  playAudio() {
    var audio = new Audio('../assets/sound/joyous-chime-notification.mp3');
    audio.play();
  }
}
