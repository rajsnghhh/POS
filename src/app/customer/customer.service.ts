...
export class CustomerService {
  ...
  getCustomers(
    ...
    const customParams = new HttpParams()
      ...
      .set('createdDate', resourceParams.createdDate ? resourceParams.createdDate.toDateString() : '')
      ...
      .set('address', resourceParams.address)
      .set('pincode', resourceParams.pincode);
