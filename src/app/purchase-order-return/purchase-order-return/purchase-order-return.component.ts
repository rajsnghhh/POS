...
export class PurchaseOrderReturnComponent extends BaseComponent {
      ...
      .subscribe((purchaseOrderData: { 'purchaseorder': PurchaseOrder }) => {
        ...
        if (this.purchaseOrder) {
          ...
          this.purchaseOrderForm = this.fb.group({
            ...
            PurchaseOrderPaymentStatus:['', [Validators.required]],
            PurchaseOrderReturnType:['', [Validators.required]],
  ...
  createPurchaseOrderItemPatch(index: number, purchaseOrderItem: PurchaseOrderItem) {
    ...
    const formGroup = this.fb.group({
      ...
      mrp:[{ value: purchaseOrderItem.mrp, disabled: true }, [Validators.required]],
      margin:[{ value: purchaseOrderItem.margin, disabled: true }, [Validators.required]],
      salesPrice:[{ value: purchaseOrderItem.salesPrice, disabled: true }, [Validators.required]],
  ...
  buildPurchaseOrder() {
    const purchaseOrder: PurchaseOrder = {
      ...
      PurchaseOrderPaymentStatus:this.purchaseOrderForm.get('PurchaseOrderPaymentStatus').value,
      PurchaseOrderReturnType:this.purchaseOrderForm.get('PurchaseOrderReturnType').value,
