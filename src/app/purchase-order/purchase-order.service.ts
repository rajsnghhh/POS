...
export class PurchaseOrderService {
  ...
  getAllWasteReturn(
    ...
    const url = 'purchaseorder/PurchaseOrderReturnSupplierWise';
    const customParams = new HttpParams()
      .set('Fields', resourceParams.fields)
      .set('OrderBy', resourceParams.orderBy)
      .set('PageSize', resourceParams.pageSize.toString())
      ...
      .set('isPurchaseOrderRequest', resourceParams.isPurchaseOrderRequest)
      .set('status', resourceParams.status)
      .set('PurchaseOrderReturnType', resourceParams.PurchaseOrderReturnType)
    return this.http.get<PurchaseOrder[]>(url, {
      params: customParams,
      observe: 'response'
    });
  ...
  uploadGRN(purchaseOrder: FormData): Observable<PurchaseOrder> {
    const url = 'UploadGRNandInventory';
    return this.http.post<PurchaseOrder>(url, purchaseOrder);
  }
