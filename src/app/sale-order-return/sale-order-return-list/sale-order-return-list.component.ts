...
export class SaleOrderReturnListComponent extends BaseComponent implements OnInit {
  ...
  displayedColumns: string[] = ['action', 'soCreatedDate', 'orderNumber', 'deliveryDate', 'customerName','onlinePayment','offlinePayment', 'totalDiscount', 'totalTax', 'totalAmount','totalPaidAmount', 'paymentStatus'];
  filterColumns: string[] = ['action-search', 'soCreatedDate-search', 'orderNumber-search', 'deliverDate-search', 'customer-search', 'totalAmount-search','onlinePayment-search','offlinePayment-search','totalDiscount-search', 'totalTax-search','totalPaidAmount-search', 'paymentStatus-search'];
