...
export class SaleOrderReturnComponent extends BaseComponent {
  ...
  buildSalesOrder() {
    ...
    if (this.payMode == 'Online') {
      this.paymentMentType = true
    } else {
      this.paymentMentType = false
    }
    const salesOrder: SalesOrder = {
      ...
      mobileNo: '',
      utrNo: this.salesOrderForm.get('utrNo').value,
      offlineMode: this.salesOrderForm.get('offlineMode').value,
      onlineOffline: this.paymentMentType,
