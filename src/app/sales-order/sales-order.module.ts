...
import { CounterWiseSalesOrderComponent } from './counter-wise-sales-order/counter-wise-sales-order.component';
...
@NgModule({
  declarations: [
    ...
    AssignDeliveryPersonComponent,
    OrderStatusComponent,
    CounterWiseSalesOrderComponent,
    // CustomRoundPipe
