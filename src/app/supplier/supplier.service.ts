...
export class SupplierService {
  ...
  addSupplierDoccument(param: any): Observable<any> {
    const url = 'AddSupplierDocument';
    return this.http.post(url, param);
  }
  getSupplierDoccuments(id: string): Observable<any> {
    const url = 'GetSupplierDocument/' + id;
    return this.http.get<any>(url);
  }
